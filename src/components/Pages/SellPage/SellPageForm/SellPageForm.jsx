...
const SellPageForm = () => {
  ...
  const onSubmit = (data) => {
    const payload = { ...data, categoryId: activeCategoryNumber };
    SendSellingFormData(payload)
      .then((res) => {
        console.log(res);
        reset({});
        setFileNames({});
