...
const DetailedCigarPage = () => {
    ...
    useEffect(() => {
        ...
        const connectToAuction = async () => {
            try {
                console.groupCollapsed(`%c[SignalR] Initializing Item Room (Item ID: ${currentItemId})`, "color: #3b82f6; font-weight: bold;");
                ...
                const handleIncomingSignalREvent = (eventName, ...args) => {
                    ...
                    // Handle if args was passed as separate parameters: e.g. (itemId, currentBid, count, nextBid)
                ...
                // Register listeners for SignalR bidding event names
                const events = [
                    "bidchanged",
                    "BidChanged",
                    "bidChanged",
